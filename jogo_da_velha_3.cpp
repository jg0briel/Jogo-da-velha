...
void lerCoordenadas(char jogada) {
    ...
    printf("Digite a linha da sua jogada (1 a 3): ");
    ...
    while (Valida(linha, coluna) == 0) {
        printf("Coordenadas Inválidas, digite a linha e a coluna da sua jogada (1 a 3): ");
        scanf(" %c%c", &linhaChar, &colunaChar);

        // Verificar se ambos os caracteres são dígitos
        while (!isdigit(linhaChar) || !isdigit(colunaChar)) {
            printf("Coordenadas Inválidas, digite a linha e a coluna da sua jogada (1 a 3): ");
            scanf(" %c%c", &linhaChar, &colunaChar);
        }
