...
// fun??o para verificar vitoria por linhas
...
// fun??o para verificar vitoria por coluna
...
// fun??o para vitoria para diagonal principal
...
// fun??o para vitoria para diagonal secund?ria
...
// fun??o para coordenadas v?lidas
...
void lerCoordenadas(char jogada) {
 ...
 do {
    ...
    linha--; // Ajuste do índice do jogador para o índice da matriz
    coluna--;
...
// fun??o que retorna a quantidade de possi??es vazias
int quantVazias() {
    int quantidade = 0;
...
void jogar() {
    ...
    if (vitoriaX == 1 && contadorX > 0){
        ...
        printf("\nDeu velha, boa sorte na pr?xima!!\n");
    }
}
